  ...
  <div class="datepicker" :style="{width: width}">
    <template v-if="hasInput">
      <input
        type="text"
        :name="name"
        :class="[{'with-reset-button': clearButton}, 'form-control', 'datepicker-input', stateClass]"
        ...
        v-model="inputValue"
      >
      <button v-if="clearButton" type="button" class="close" @click="clearinput">
        <span>&times;</span>
      </button>
    </template>
    ...
    >
      <div class="datepicker-ctrl">
        <span
          class="datepicker-preBtn fa fa-angle-left"
          aria-hidden="true"
          @click="preNextMonthClick(0)"
        ></span>
        <span
          class="datepicker-nextBtn fa fa-angle-right"
          aria-hidden="true"
      ...
      <template v-for="(p, pan) in pane">
        <div class="datepicker-inner">
          <div class="datepicker-body">
            ...
            >{{stringifyDayHeader(currDate, pan)}}</p>
            <div class="datepicker-weekRange">
              <span v-for="w in text.daysOfWeek">{{w}}</span>
            </div>
            <div class="datepicker-dateRange">
              <span
                v-for="d in dateRange[pan]"
                class="day-cell"
                :class="getItemClasses(d)"
                :data-date="stringify(d.date)"
                @click.self="daySelect(d.date, $event)"
              >
                <template
        ...
        <div class="datepicker-inner">
          <div class="datepicker-body">
            <p
              ...
              style="cursor: pointer;"
            >{{stringifyYearHeader(currDate, pan)}}</p>
    ...
    <div class="datepicker-popup" :style="paneStyle" v-show="displayYearView">
      ...
      <template v-for="(p, pan) in pane">
        <div class="datepicker-inner">
          <div class="datepicker-body">
            <p style="cursor: pointer;">{{stringifyDecadeHeader(currDate, pan)}}</p>
...
export default {
  ...
  methods: {
    ...
    getItemClasses(d) {
      ...
      if (this.rangeStart && this.rangeEnd && d.date < this.rangeStart) {
    ...
    updatePaneStyle() {
      if (!(this.displayMonthView || this.displayYearView)) {
        this.$nextTick(function() {
          ...
          let offsetWidth = this.$el.querySelector('.datepicker-inner')
            .offsetWidth
    ...
    daySelect(date, event) {
      let el = event.target
      if (el.classList.contains('datepicker-item-disable')) {
        return false
      } else {
        if (this.hasInput) {
          this.currDate = date
